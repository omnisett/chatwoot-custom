...
RSpec.describe Instagram::CallbacksController do
  ...
  before do
    ...
    stub_request(:post, 'https://graph.instagram.com/v22.0/12345/subscribed_apps?access_token=long_lived_test_token&subscribed_fields=messages%2Cmessage_reactions%2Cmessaging_seen%2Ccomments')
      .with(
        headers: {
          'Accept' => '*/*',
